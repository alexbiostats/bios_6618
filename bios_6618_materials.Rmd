...
mat_reg_desc <- c('In some cases data may have change points where the slope significantly changes before versus after the point, this can be evaluated through segmented regression.',
                  ...
                  'The Bayesian version of simple linear regression, with examples of models fits in JAGS and Stan.',
                  'The Bayesian version of multiple linear regression, with examples of models fits in JAGS and Stan.',
