...
We assume some material has been covered in previous statistic coursework. No worries if it isn't ringing a bell, feel free to review the material below.
...
mat_reg_desc <- c('In some cases data may have change points where the slope significantly changes before versus after the point, this can be evaluated through segmented regression.',
                  ...
                  'Advanced bootstrap topics are discussed including alternative CI calculations and different bootstrap algorithms.',
                  ...
                  'The Bayesian version of linear regression, with examples of models fits in using Stan/brms.',
